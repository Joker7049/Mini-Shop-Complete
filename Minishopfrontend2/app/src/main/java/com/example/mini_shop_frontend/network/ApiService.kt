...
interface ApiService {
    ...
    suspend fun getMyOrders(@Header("Authorization") token: String): Response<List<OrderHistoryDto>>

    @GET("api/cart") suspend fun getCart(@Header("Authorization") token: String): Response<CartDto>
