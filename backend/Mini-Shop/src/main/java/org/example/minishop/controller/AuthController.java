...
import org.example.minishop.service.RateLimitingService;
...
public class AuthController {
    ...
    public AuthController(AuthenticationManager authenticationManager, JwtUtil jwtUtil, UserService userService,  RateLimitingService rateLimitingService) {
    ...
    public ResponseEntity<Map<String, String>> register(@Valid @RequestBody SignUpRequest request) {
        ...
        // 1. Register User
        // If username exists, Service throws BadRequestException -> Global Handler
        // catches it.
